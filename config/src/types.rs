...
pub struct WalletConfig {
	...
	/// Whether to include the whymqs listener
	...
	fn default() -> WalletConfig {
		WalletConfig {
			...
			swap_electrumx_addr: Some(
				[
					("btc_main_1", "btc.main1.swap.why.mw:18337"),
					("btc_main_2", "btc.main2.swap.why.mw:18337"),
					("btc_test_1", "btc.test1.swap.why.mw:18339"),
					("btc_test_2", "btc.test2.swap.why.mw:18339"),
					("bch_main_1", "bch.main1.swap.why.mw:18333"),
					("bch_main_2", "bch.main2.swap.why.mw:18333"),
					("bch_test_1", "bch.test1.swap.why.mw:18335"),
					("bch_test_2", "bch.test1.swap.why.mw:18335"),
					("dash_main_1", "dash.main1.swap.why.mw:18351"),
					("dash_main_2", "dash.main2.swap.why.mw:18351"),
					("dash_test_1", "dash.test1.swap.why.mw:18349"),
					("dash_test_2", "dash.test1.swap.why.mw:18349"),
					("doge_main_1", "doge.main1.swap.why.mw:18359"),
					("doge_main_2", "doge.main2.swap.why.mw:18359"),
					("doge_test_1", "doge.test1.swap.why.mw:18357"),
					("doge_test_2", "doge.test1.swap.why.mw:18357"),
					("ltc_main_1", "ltc.main1.swap.why.mw:18343"),
					("ltc_main_2", "ltc.main2.swap.why.mw:18343"),
					("ltc_test_1", "ltc.test1.swap.why.mw:18341"),
					("ltc_test_2", "ltc.test1.swap.why.mw:18341"),
					("zcash_main_1", "zcash.main1.swap.why.mw:18355"),
					("zcash_main_2", "zcash.main2.swap.why.mw:18355"),
					("zcash_test_1", "zcash.test1.swap.why.mw:18353"),
					("zcash_test_2", "zcash.test1.swap.why.mw:18353"),
				]
				.iter()
				.cloned()
...
impl Default for MQSConfig {
	fn default() -> MQSConfig {
		MQSConfig {
			whymqs_domain: "mqs.why.mw".to_owned(),
			whymqs_port: 443,
		}
	}
}
