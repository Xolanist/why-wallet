...
impl Client {
	...
	fn build_request(
		...
		url: &str,
		method: &str,
		basic_auth_key: Option<String>, // In Node will be generated. Specify None if talk to the Node. Another wallet wants 'why'
		api_secret: Option<String>,
		body: Option<String>,
	...
	pub fn create_post_request<IN>(
		&self,
		url: &str,
		basic_auth_key: Option<String>, // Specify None if talk to the Node. Another wallet wants 'why'
		api_secret: Option<String>,
		input: &IN,
	) -> Result<Request<Body>, Error>
	where
